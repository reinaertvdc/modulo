class WebPageParser:
    ...
    def get_certificate_file_urls(self, section_title):
        section = self.__get_section(section_title)
        certificate_file_urls = []
        ...
        while True:
            ...
            certificate_file_urls.append(section[current_certificate_file_url_index + len(
                self.__FILE_URL_START_TAG):section.find(self.__FILE_URL_END_TAG, current_certificate_file_url_index)])
            last_certificate_file_url_index = current_certificate_file_url_index
        return certificate_file_urls
